"""
Dallas Fed Manufacturing Survey scraper.
Source: dallasfed.org — General Business Activity composite index.
Released last Monday of the month.
"""
...
_BASE_URL = "https://www.dallasfed.org/research/surveys/tmos"
_UA = (
...
def _fetch_history() -> list[dict]:
    """Scrape General Business Activity composite from Dallas Fed survey page."""
...
def fetch(indicator_id: str, _config: dict) -> dict | None:
    global _cache
    if _cache is None:
        logger.info("Dallas Fed: fetching manufacturing survey data")
